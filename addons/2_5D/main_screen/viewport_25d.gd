...
onready var gizmo_25d_scene = preload("res://addons/node2dot5/main_screen/gizmo_25d.tscn")
...
func _ready():
  ...
  if !edited_scene_root:
    ...
    editor_interface.set_plugin_enabled("node2dot5", false)
    editor_interface.set_plugin_enabled("node2dot5", true)
    return
